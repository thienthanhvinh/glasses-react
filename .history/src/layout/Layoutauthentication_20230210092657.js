  ...
  return (
    <div className="w-full h-screen bg-white p-12">
      <div className="mb-6 flex justify-between items-center">
        ...
        />
        <div className="w-[80px] h-8 border border-gray-300 rounded-full flex items-center">
          <div className="darkmoded-spinner transition-all duration-500">
             <BsFillSunFill size={"24px"} color={"#e9c46a"}></BsFillSunFill>
          </div>
        </div>
        </label>
