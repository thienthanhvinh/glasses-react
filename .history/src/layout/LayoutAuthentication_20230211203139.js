...
const LayoutAuthentication = ({ heading, question, children }) => {
  ...
  return (
    <div className="w-full h-screen bg-white dark:bg-dark-secon-color p-12">
      ...
      <div className="w-full max-w-[550px] bg-white-400  dark:bg-dark-third-color shadow-md rounded-lg mx-auto px-12 py-5">
