  ...
  return (
    <div className="w-full h-screen bg-white p-12">
      <div className="mb-6 flex justify-between items-center">
        ...
        />
        <div className="w-[80px] h-8 border border-gray-300 rounded-full py-2">
          <div className="w-7 h-7 rounded-full bg-[#ccc] darkmoded-spinner transition-all duration-500"></div>
        </div>
        </label>
