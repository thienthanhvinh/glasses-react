  ...
  return (
    <div className="w-full h-screen bg-white p-12">
      <div className="mb-6 flex justify-between items-center">
        ...
        />
        {isDarkMode ? <BsFillSunFill size={"24px"} color={"#e9c46a"} onClick={() => toggleDarkMode(!isDarkMode)}></BsFillSunFill> : <FaMoon size={"24px"} color={"pri"} onClick={() => toggleDarkMode(!isDarkMode)}></FaMoon> }
