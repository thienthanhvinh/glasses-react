  ...
  return (
    <div className="w-full h-screen bg-white p-12">
      <div className="mb-6 flex justify-between items-center">
        ...
        />
        {isDarkMode ? <BsFillSunFill size={"24px"} color={"#e9c46a"} onClick={() => toggleDarkMode(!isDarkMode)}></BsFillSunFill> : <FaMoon size={"24px"} color={"#808191"} onClick={() => toggleDarkMode(!isDarkMode)}></FaMoon> }
      ...
      <div className="w-full max-w-[550px] bg-white-400  dark:bg-black shadow-md rounded-lg mx-auto px-12 py-5">
